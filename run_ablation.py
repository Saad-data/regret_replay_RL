"""Unified ablation training script. Trains RMER with a single ablation config."""
...
from ablation_configs import get_config, get_run_name
...
def train_ablation(config_name, env_name, seed, total_steps):
    """Train RMER with a specific ablation configuration."""
